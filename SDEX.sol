...
contract SDEXToken is ERC20, Ownable, ERC20Burnable {
    constructor() public ERC20("Sigmadex", "SDEX") {
    }
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying SDEX (not scaled);
